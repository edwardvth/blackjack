...
if player_sum > dealer_sum:import random
import time
...
dealerHidden = cards[deal_for_d1][0]
dealerValHidden = cards[deal_for_d1][1]

print("Dealer:", dealer, 'Covered Card,', " Total known sum of dealer's cards is ", dealer_sum)

del cards[deal_for_d]
del cards[deal_for_d1]
...
print("\n The dealer will reveal their cards and it will be told who the winner will be. \n ")

time.sleep(5)

dealer += dealerHidden
dealer_sum += dealerValHidden
